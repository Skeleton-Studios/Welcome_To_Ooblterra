...
namespace Welcome_To_Ooblterra.Enemies
{
    public class GallenarmaAI : WTOEnemy, INoiseListener {
        ...
        public static Dictionary<int, GallenarmaAI> GallenarmaList = new();
        ...
        public List<AudioClip> Search = new();
        ...
        private struct NoiseInfo
        {
            ...
            public Vector3 Location { get => position; private set => position = value; }
