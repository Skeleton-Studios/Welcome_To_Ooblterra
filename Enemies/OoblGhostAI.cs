...
#pragma warning restore 0649
        ...
        private class WaitForNextAttack : BehaviorState {
            ...
            public override List<StateTransition> transitions { get; set; } = new() {
                new AttackTimerDone()
            };
        }
        ...
        private static readonly Dictionary<PlayerControllerB, int> PlayersTimesHaunted = new();
        ...
        private void Awake()
        {
            ...
            GhostRenderer.materials = new Material[] { GhostMat, GhostMat, GhostTeethMat };
            GhostArmsRenderer.materials = new Material[] { GhostMat };
        }
